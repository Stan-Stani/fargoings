...
const events = db.getDisplayEvents(limit, offset);

console.log(`\n🖥️  Display Events (${events.length} shown, offset: ${offset}):\n`);
...
console.log('─'.repeat(80));
console.log(`Total display rows: ${db.getDisplayCount()}`);
console.log(`\nUsage: npx tsx src/browse-display.ts [limit] [offset]`);
